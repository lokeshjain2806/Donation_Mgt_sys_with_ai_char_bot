    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gmail', models.CharField(blank=True, max_length=150, null=True, verbose_name='Gmail')),
                ('linkdin', models.CharField(blank=True, max_length=150, null=True, verbose_name='Linkdin')),
                ('created_at', models.DateField(auto_now=True)),
                ('updated_at', models.DateField(blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Is Volunteers', 'Is Volunteers'), ('Is Donor', 'Is Donor')], max_length=20)),
